...
namespace UserAccess.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241105184446_Update-Friend-v2")]
    partial class UpdateFriendv2
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("UserAccess.Domain.Entities.FriendRequest", "FriendRequests", b1 =>
                        {
                            ...
                            b1.Property<Guid>("FriendUserRequestId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("FriendUserRequestId");
                    ...
                    b.OwnsMany("UserAccess.Domain.Entities.SentFriendRequest", "SentFriendRequests", b1 =>
                        {
                            ...
                            b1.Property<Guid>("FriendUserSentId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("FriendUserSentId");
