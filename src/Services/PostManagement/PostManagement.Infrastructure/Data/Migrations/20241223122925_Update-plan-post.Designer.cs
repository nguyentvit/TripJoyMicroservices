...
namespace PostManagement.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241223122925_Update-plan-post")]
    partial class Updateplanpost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PostManagement.Domain.Models.Comment", b =>
                {
                    ...
                    b.OwnsMany("PostManagement.Domain.ValueObjects.CommentId", "CommentReplyIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("CommentReply", (string)null);
