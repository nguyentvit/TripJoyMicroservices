        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProvinceIdEnd = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProvinceNameEnd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProvinceIdStart = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProvinceNameStart = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentReaction", x => new { x.CommentReactionId, x.CommentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentIds_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostImage", x => new { x.PostImageId, x.PostId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "PostPlanLocation",
                columns: table => new
                {
                    PostPlanLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostPlanLocation", x => new { x.PostPlanLocationId, x.PostId });
                    table.ForeignKey(
                        name: "FK_PostPlanLocation_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostReaction", x => new { x.PostReactionId, x.PostId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostPlanLocation_PostId",
